			...
			if(isset($_POST['submit']))
			{
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					else
					{
						...
						if($avg>87)
							echo "You are eligible to apply for LUMS<br>";
						else if($avg>60)
							echo "You are eligible to apply for NUST<br>";
						if($bits>280)
							echo "You are eligible to apply for COMSATS<br>";
						if($srm>140)
							echo "You are eligible to apply for FAST<br>";
						if($vit>80)
							echo "You are eligible to apply for Iqra University<br>";
					}
					echo "</div>";
				}
			}
